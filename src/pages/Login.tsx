              ...
              <div className="space-y-6">
                <div className="text-center lg:text-left">
                  <h2 className="text-2xl font-orbitron font-bold text-white mb-2">
                    Últimas Noticias Galácticas
                  </h2>
                  <p className="text-gray-400 font-rajdhani">
                    Eventos épicos suceden cada día en nuestros universos
                  </p>
                </div>
                ...
                <div className="p-4 bg-gradient-to-r from-neon-purple/10 to-neon-blue/10 border border-neon-purple/30 rounded-lg">
                  <div className="text-center space-y-3">
                    <div className="flex items-center justify-center space-x-2">
                      <Star className="w-5 h-5 text-neon-orange animate-pulse" />
                    ...
                    <p className="text-xs text-gray-300">
                      Más de 50,000 comandantes ya forjan su destino entre las estrellas
                    </p>
                    <div className="grid grid-cols-3 gap-2 text-center">
                      <div>
                        <p className="text-lg font-orbitron font-bold text-neon-blue">6</p>
                        <p className="text-xs text-gray-400">Universos</p>
                      </div>
                      <div>
                        <p className="text-lg font-orbitron font-bold text-neon-green">24/7</p>
